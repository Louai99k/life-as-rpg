...
const MagicIcon = ({ height, width }: IconProps) => {
  return (
    <svg
    ...
    >
      <g fill="none">
        <path fill="#433B6B" d="m5 29l-2-2l16-16l2 2L5 29Z"></path>
        <path
          fill="#F4F4F4"
          d="m18 12l2 2l1.674-1.667c.435-.445.435-1.24 0-1.675l-.33-.331C20.9 9.89 20 10 19.5 10.5L18 12ZM2.338 29.252l.41.41c.44.452 1.17.452 1.61-.01L6 28.007L4 26l-1.663 1.627a1.146 1.146 0 0 0 0 1.625Z"
        ></path>
        <path
          fill="#F9C23C"
